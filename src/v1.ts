...
function v1() {
  try {
    ...
    const uuid = 'xxxxxxxx-xxxx-1xxx-xxxx-xxxxxxxxxxxx'.replace(/[x]/g, function () {
    ...
    const uuidWithProcessIDs = uuidWithTimestamp.replace(/xxxx-xxxxxxxxxxxx/, `${ppidHex}-${pidHex}`)
